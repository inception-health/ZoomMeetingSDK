...
@property (strong, nonatomic) UITableViewCell *hiddenSelfViewCell;
...
@property (strong, nonatomic) UITableViewCell *hideWebinarRegisterCell;
@property (strong, nonatomic) UITableViewCell *enableCenterStageCell;
...
@property (strong, nonatomic) UITableViewCell *hideNovideoUserEnableCell;
...
- (void)viewDidLoad {
    ...
    if ([[MobileRTC sharedRTC] isSupportedCustomizeMeetingUI])
    {
        ...
        BOOL enableCustomMeeting = [[MobileRTC sharedRTC] isEnabledCustomizeMeetingUI];
        ...
        [self onEnableCustomMeetingHint:enableCustomMeeting];
    }
    ...
    [hiddenArray addObject:[self hideNovideoUserEnableCell]];
    [hiddenArray addObject:[self hiddenSelfViewCell]];
    [hiddenArray addObject:[self hideWebinarRegisterCell]];
    
    MobileRTCMeetingSettings *settings = [[MobileRTC sharedRTC] getMeetingSettings];
    if ([settings isCenterStageModeSupported]) {
        [hiddenArray addObject:[self enableCenterStageCell]];
    }
...
- (UITableViewCell*)hiddenSelfViewCell
{
    MobileRTCMeetingSettings *settings = [[MobileRTC sharedRTC] getMeetingSettings];
    if (!settings)
        return nil;
    
    BOOL hidden = [settings isHideSelfViewEnabled];
    
    if (!_hiddenSelfViewCell)
    {
        _hiddenSelfViewCell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];
        _hiddenSelfViewCell.selectionStyle = UITableViewCellSelectionStyleNone;
        _hiddenSelfViewCell.textLabel.text = NSLocalizedString(@"Hide My View", @"");
        
        UISwitch *sv = [[UISwitch alloc] initWithFrame:CGRectZero];
        [sv setOn:hidden animated:NO];
        [sv addTarget:self action:@selector(onHideSelfView:) forControlEvents:UIControlEventValueChanged];
        _hiddenSelfViewCell.accessoryView = sv;
    }
    
    return _hiddenSelfViewCell;
}

- (void)onHideSelfView:(id)sender {
    UISwitch *sv = (UISwitch*)sender;
    [self.settingPresenter setHiddenMySelfView:sv.on];
}
...
- (UITableViewCell*)hideNovideoUserEnableCell
{
    MobileRTCMeetingSettings *settings = [[MobileRTC sharedRTC] getMeetingSettings];
    if (!settings)
        return nil;
    
    BOOL hidden = [settings isHideNoVideoUsersEnabled];
    
    if (!_hideNovideoUserEnableCell)
    {
        _hideNovideoUserEnableCell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];
        _hideNovideoUserEnableCell.selectionStyle = UITableViewCellSelectionStyleNone;
        _hideNovideoUserEnableCell.textLabel.text = NSLocalizedString(@"Show Non-Video Participants", @"");
        
        UISwitch *sv = [[UISwitch alloc] initWithFrame:CGRectZero];
        [sv setOn:hidden animated:NO];
        [sv addTarget:self action:@selector(onNoVideoButtonHidden:) forControlEvents:UIControlEventValueChanged];
        _hideNovideoUserEnableCell.accessoryView = sv;
    }
    
    return _hideNovideoUserEnableCell;
}
...
- (void)onNoVideoButtonHidden:(id)sender
{
    UISwitch *sv = (UISwitch*)sender;
    [self.settingPresenter setHideNoVideoUsersEnabled:sv.on];
}
...
- (void)onEnableCustomMeetingHint:(BOOL)isCustomUI
{
    BOOL hasRawDataLicense = [[MobileRTC sharedRTC] hasRawDataLicense];
    if (isCustomUI) {
...
- (UITableViewCell*)hideWebinarRegisterCell
{
    MobileRTCMeetingSettings *settings = [[MobileRTC sharedRTC] getMeetingSettings];
    if (!settings)
        return nil;
    
    BOOL hidden = [settings hideRegisterWebinarInfoWindow];
    
    if (!_hideWebinarRegisterCell)
    {
        _hideWebinarRegisterCell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];
        _hideWebinarRegisterCell.selectionStyle = UITableViewCellSelectionStyleNone;
        _hideWebinarRegisterCell.textLabel.text = NSLocalizedString(@"Hide Webinar register dialog", @"");
        
        UISwitch *sv = [[UISwitch alloc] initWithFrame:CGRectZero];
        [sv setOn:hidden animated:NO];
        [sv addTarget:self action:@selector(onHideWebinarRegister:) forControlEvents:UIControlEventValueChanged];
        _hideWebinarRegisterCell.accessoryView = sv;
    }
    
    return _hideWebinarRegisterCell;
}

- (void)onHideWebinarRegister:(id)sender {
    UISwitch *sv = (UISwitch*)sender;
    [[[MobileRTC sharedRTC] getMeetingSettings] setHideRegisterWebinarInfoWindow:sv.on];
}


- (UITableViewCell*)enableCenterStageCell
{
    MobileRTCMeetingSettings *settings = [[MobileRTC sharedRTC] getMeetingSettings];
    if (!settings)
        return nil;
    
    BOOL hidden = [settings isEnabledCenterStageMode];
    
    if (!_enableCenterStageCell)
    {
        _enableCenterStageCell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];
        _enableCenterStageCell.selectionStyle = UITableViewCellSelectionStyleNone;
        _enableCenterStageCell.textLabel.text = NSLocalizedString(@"Enable CenterStage Mode", @"");
        
        UISwitch *sv = [[UISwitch alloc] initWithFrame:CGRectZero];
        [sv setOn:hidden animated:NO];
        [sv addTarget:self action:@selector(enableCenterStageModeAction:) forControlEvents:UIControlEventValueChanged];
        _enableCenterStageCell.accessoryView = sv;
    }
    
    return _enableCenterStageCell;
}

- (void)enableCenterStageModeAction:(id)sender {
    UISwitch *sv = (UISwitch*)sender;
    [[[MobileRTC sharedRTC] getMeetingSettings] enableCenterStageMode:sv.on];
}
