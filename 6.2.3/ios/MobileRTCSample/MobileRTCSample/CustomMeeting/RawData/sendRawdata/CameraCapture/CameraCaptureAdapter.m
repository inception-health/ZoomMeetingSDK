...
didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer
    ...
    [_videoRawdataSender sendVideoFrame:(char *)buf width:width height:height dataLength:width * height * 3/ 2 rotation:rotate format:MobileRTCFrameDataFormat_I420];
