...
- (void)onSinkMeetingActiveVideo:(NSUInteger)userID
{
    ...
    if (self.customMeetingVC && [self.customMeetingVC respondsToSelector:@selector(onSinkMeetingActiveVideo:)])
    {
...
- (void)onSinkMeetingPreviewStopped
{
    ...
    if (self.customMeetingVC && [self.customMeetingVC respondsToSelector:@selector(onSinkMeetingPreviewStopped)])
    {
...
- (void)onSinkMeetingVideoStatusChange:(NSUInteger)userID
{
    ...
    if (self.customMeetingVC && [self.customMeetingVC respondsToSelector:@selector(onSinkMeetingVideoStatusChange:)])
    {
...
- (void)onMyVideoStateChange
{
    ...
    if (self.customMeetingVC && [self.customMeetingVC respondsToSelector:@selector(onMyVideoStateChange)])
    {
