...
- (void)onSinkMeetingUserJoin:(NSUInteger)userID
{
    ...
    if (self.customMeetingVC && [self.customMeetingVC respondsToSelector:@selector(onSinkMeetingUserJoin:)])
    {
...
- (void)onSinkMeetingUserLeft:(NSUInteger)userID
{
    ...
    if (self.customMeetingVC && [self.customMeetingVC respondsToSelector:@selector(onSinkMeetingUserLeft:)])
    {
