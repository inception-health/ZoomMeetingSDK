...
- (void)onSinkMeetingAudioStatusChange:(NSUInteger)userID
{
    ...
    if (self.customMeetingVC && [self.customMeetingVC respondsToSelector:@selector(onSinkMeetingAudioStatusChange:)])
    {
...
- (void)onSinkMeetingMyAudioTypeChange
{
    ...
    if (self.customMeetingVC && [self.customMeetingVC respondsToSelector:@selector(onSinkMeetingMyAudioTypeChange)])
    {
